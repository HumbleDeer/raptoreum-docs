...
- sendtoaddress: [raptoreum-cli - sendtoaddress](/wallet/cli-wallet/commands/wallet/sendtoaddress.mdx) 
- raptoreum-cli: [raptoreum-cli Quick Start](/wallet/cli-wallet/quick-start.mdx)
