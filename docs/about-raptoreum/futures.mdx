...
- sendtoaddress: [raptoreum-cli - sendtoaddress](/docs/wallet/cli-wallet/commands/wallet/sendtoaddress.mdx) 
- raptoreum-cli: [raptoreum-cli Quick Start](/docs/wallet/cli-wallet/quick-start.mdx)
