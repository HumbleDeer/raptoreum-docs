...
- sendtoaddress: [raptoreum-cli - sendtoaddress](docs/wallet/cli-wallet/commands/wallet/sendtoaddress) 
- raptoreum-cli: [raptoreum-cli Quick Start](docs/wallet/cli-wallet/getting-started)
