...
tar -xvf raptoreum_1.2.15.3_ubuntu20_64.tar.gz
cd ..
wget https://github.com/Raptor3um/raptoreum/releases/download/1.2.15.3/bootstrap.zip
unzip bootstrap.zip
...
*For this step, you will need the RaptoreumCore wallet installed. Follow our [Installing RaptoreumCore](/docs/wallet/) guide for detailed instructions on how to do this.*
