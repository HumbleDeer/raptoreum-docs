...
- Download bootstrap.zip listed on our latest release: https://github.com/Raptor3um/raptoreum/releases/
...
1. Download: <https://github.com/Raptor3um/raptoreum/releases/ (look for bootstrap.zip in latest release)
