...
Set the goal amount in RTM for PrivateSend mixing.

`raptoreum-cli setprivatesendamount 500`

<ReactPlayer playing controls url={[
    {src: `${require('./assets/setprivatesendamount.webm').default}`, type: 'video/webm'}]} />
