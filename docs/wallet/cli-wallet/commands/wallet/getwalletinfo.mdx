...
<ReactPlayer playing controls url={[
    {src: `${require('./assets/getwalletinfo.webm').default}`, type: 'video/webm'}]} />
...
Result:
{
  ...
  "balance": xxxxxxx,         (numeric) the total confirmed balance of the wallet in RTM
  "privatesend_balance": xxxxxx, (numeric) the PrivateSend balance in RTM
  "unconfirmed_balance": xxx, (numeric) the total unconfirmed balance of the wallet in RTM
  "immature_balance": xxxxxx, (numeric) the total immature balance of the wallet in RTM
  ...
  "paytxfee": x.xxxx,         (numeric) the transaction fee configuration, set in RTM/kB
