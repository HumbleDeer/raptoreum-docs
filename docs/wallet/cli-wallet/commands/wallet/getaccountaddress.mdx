...
DEPRECATED. Returns the current Raptoreum address for receiving payments to this account.
...
<ReactPlayer playing controls url={[
    {src: `${require('./assets/getaccountaddress.webm').default}`, type: 'video/webm'}]} />
