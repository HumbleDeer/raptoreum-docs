...
raptoreum-cli getreceivedbyaccount ""

# Amount received at the tabby account including unconfirmed amounts with zero confirmations
raptoreum-cli getreceivedbyaccount "tabby" 0

# The amount with at least 6 confirmations
raptoreum-cli getreceivedbyaccount "tabby" 6
```

<ReactPlayer playing controls url={[
    {src: `${require('./assets/getreceivedbyaccount.webm').default}`, type: 'video/webm'}]} />
