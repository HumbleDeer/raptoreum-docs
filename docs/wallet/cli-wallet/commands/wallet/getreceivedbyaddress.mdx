...
<ReactPlayer playing controls url={[
    {src: `${require('./assets/getreceivedbyaddress.webm').default}`, type: 'video/webm'}]} />

## Arguments

| Argument | Type | Description |
|--|--|--|
| "address" | (string) | The raptoreum address for transactions.  |
...
|--|--|--|
| amount | (numeric) | The total amount in RTM received for this address. |
