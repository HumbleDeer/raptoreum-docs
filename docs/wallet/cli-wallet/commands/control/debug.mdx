...
```bash
curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "debug", "params": [raptoreum+net] }' -H 'content-type: text/plain;' http://127.0.0.1:9998/
```
